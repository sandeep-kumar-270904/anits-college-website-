  ...
  return (
    <div className="font-sans pt-[52px] min-h-screen bg-gray-50 pb-16">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 text-center">
        <h2 className="text-xl font-bold text-[#112a46] mb-6">Yoga Centre</h2>
        
        <div className="space-y-4 text-gray-700 max-w-3xl mx-auto mb-12">
          <p>In H Block Room no H-403 is maintained as Yoga Centre for boys</p>
          <p>In H Block Room no H-406 is maintained as Yoga Centre for girls</p>
        </div>
